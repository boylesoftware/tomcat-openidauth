...
abstract class SEL<T>
	...
	enum SELType {
		 ...
		 */
		private SELType(final int noDefaultFlag) {
	...
	enum Match {
		 ...
		 */
		public static Match fromAttribute(final String attVal) {
	 ...
	 */
	SEL(final SELType type, final Class<T> queryValueClass,
			final String value, final boolean select, final Match match) {
	 ...
	 * {@link #NEGATIVE_MATCH}.
	 */
	public final int match(final Object queryValue, final int flags) {
