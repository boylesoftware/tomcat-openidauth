...
class ComplexURI {
	...
	enum Append {
		 ...
		 */
		public static Append fromAttribute(final String attVal) {
	 ...
	 * is used.
	 */
	ComplexURI(final URI uri, final Integer priority, final Append append) {
	 ...
	 */
	public static ComplexURI select(final Collection<ComplexURI> curis) {

		if (curis.isEmpty())
			return null;

		final List<ComplexURI> selected = new ArrayList<>(
