...
public class XRD
	...
	public enum CIDVerificationStatus {
		 ...
		 */
		public static CIDVerificationStatus fromAttribute(final String attVal) {
	 ...
	 * SEPs.
	 */
	private final Collection<SEP> seps = new ArrayList<>();
	 ...
	 * {@code null}.
	 */
	XRD(@SuppressWarnings("unused") final String id,
			@SuppressWarnings("unused") final String idRef) {
	 ...
	 * @param type The type.
	 */
	void addType(@SuppressWarnings("unused") final URI type) {
	 ...
	 */
	void setQuery(@SuppressWarnings("unused") final String query) {
	...
	void setStatus(final int code,
			final CIDVerificationStatus cidVerificationStatus,
			@SuppressWarnings("unused") final CIDVerificationStatus ceidStatus,
	 ...
	 * @param message Status message.
	 */
	void setServerStatus(@SuppressWarnings("unused") final int code,
	 ...
	 */
	void setExpires(@SuppressWarnings("unused") final Date date) {
	 ...
	 * @param priority Priority, or {@code null}.
	 */
	void addEquivID(@SuppressWarnings("unused") final URI uri,
			@SuppressWarnings("unused") final Integer priority) {
	 ...
	 */
	void setCanonicalID(final URI canonicalID) {
	 ...
	 * @param uri The ID.
	 */
	void setCanonicalEquivID(@SuppressWarnings("unused") final URI uri) {
	 ...
	 */
	public Collection<SEP> findSEPs(final URI type) {
	 ...
	 */
	public SEP selectSEP(final URI type, final String path,
			final String mediaType, final int flags) {
		...
		final List<SEP> highestPriSEPs = new ArrayList<>(
				selectedSEPs.size() > 10 ? selectedSEPs.size() : 10);
		int highestPri = Integer.MAX_VALUE;
		for (final Iterator<SEP> it = selectedSEPs.iterator(); it.hasNext();) {
			final SEP sep = it.next();
	 ...
	 */
	private List<SEP> selectSEPs(final URI type, final String path,
			final String mediaType, final int flags) {

		final List<SEP> selectedSEPs = new ArrayList<>(
		...
		int i = -1;
		SEP: for (final SEP sep : this.seps) {

			i++;

			for (final SEL.SELType selType : SEL.SELType.values()) {
				for (final SEL<?> sel : sep.getSELs(selType)) {
