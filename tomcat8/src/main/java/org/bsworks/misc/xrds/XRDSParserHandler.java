...
class XRDSParserHandler
	 ...
	 */
	private final StringBuilder elContent = new StringBuilder(256);
	 ...
	 */
	private void processXRDSubelement(final String localName)
		...
		if (localName.equals("Type")) {
			...
			final String priority = this.elAtts.getValue("priority");
	 ...
	 * @throws URISyntaxException If a URI attribute has an invalid value.
	 */
	private void processSEPSubelement(final String localName)
		throws URISyntaxException {
