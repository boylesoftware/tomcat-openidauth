...
public class OpenIDRealm
	 ...
	 * @return Authenticated user, or {@code null} if unsuccessful.
	 */
	private Principal authenticate(final AuthenticationMethod method,
		...
		final Iterator<Realm> i = this.realms.iterator();
		if (!i.hasNext()) {
			if (debug)
	 ...
	 * unsuccessful.
	 */
	Principal authenticateOpenID(final String username) {
